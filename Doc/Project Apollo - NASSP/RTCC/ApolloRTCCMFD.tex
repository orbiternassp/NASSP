...
\textbf{OPT:} Optimize the Delta V of the maneuver or not. If this is used for APS MCC-1 it can shift away the impact time from the flight plan time. If this option is not used however then the initial guess has to be fairly close to the desired solution or else a very long burn duration could be the result of the calculation.\\
