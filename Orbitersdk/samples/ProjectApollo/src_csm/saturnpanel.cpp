...
void Saturn::PanelIndicatorSwitchStateRequested(IndicatorSwitch *s) {
	...
	if (s == &FuelCellPhIndicator) {
		...
		//Reaction valves indicators for Apollo 13 and before were wired in series with the valves so both valves had to close before the talkback would barberpole
	} else if (s == &FuelCellReactants1Indicator) {
		if (((*(int*)Panelsdk.GetPointerByString("HYDRAULIC:H2FUELCELL1MANIFOLD:IN:ISOPEN") == 1) ||
			(*(int*)Panelsdk.GetPointerByString("HYDRAULIC:O2FUELCELL1MANIFOLD:IN:ISOPEN") == 1)) &&
		...
		if (((*(int*)Panelsdk.GetPointerByString("HYDRAULIC:H2FUELCELL2MANIFOLD:IN:ISOPEN") == 1) ||
			(*(int*)Panelsdk.GetPointerByString("HYDRAULIC:O2FUELCELL2MANIFOLD:IN:ISOPEN") == 1)) &&
		...
		if (((*(int*)Panelsdk.GetPointerByString("HYDRAULIC:H2FUELCELL3MANIFOLD:IN:ISOPEN") == 1) ||
			(*(int*)Panelsdk.GetPointerByString("HYDRAULIC:O2FUELCELL3MANIFOLD:IN:ISOPEN") == 1)) &&
