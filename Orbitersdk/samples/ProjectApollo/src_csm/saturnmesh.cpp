...
void CMContinuumFlowAero(double alpha, double Mach, double &C_M, double &C_L, double &C_D)
{
	...
	static const double C_L_arr[14][26] = { {0,0.057191,0.107249,0.163697,0.21463,0.197276,-0.0923653,-0.0929259,-0.257066,-0.23,-0.14224,0.0937741,0.168309,
	...
	static const double C_D_arr[14][26] = { {0.548,0.527952,0.48599,0.452468,0.441178,0.406234,0.260019,0.0955446,0.269737,0.266,0.230807,0.239523,0.266093,
	...
	for (i = 0; i < 15 && Mach_arr[i + 1] < Mach; i++);
	for (j = 0; j < 25 && alpha_arr[j + 1] < alpha; j++);
