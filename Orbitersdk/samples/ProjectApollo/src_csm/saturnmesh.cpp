	...
	static const double Mach_arr[] = { 0.0, 0.2, 0.4, 0.7, 0.9, 1.1, 1.2, 1.35, 1.65, 2.0, 2.4, 3.0, 4.0, 10.0, 29.5, 50.0 };
	static const double alpha_arr[] = { 0, 10.0* RAD, 20.0 * RAD, 30.0 * RAD, 40.0 * RAD, 50.0 * RAD, 60.0 * RAD, 70.0 * RAD, 80.0 * RAD, 90.0 * RAD, 100.0 * RAD, 110.1365*RAD, 115.1365*RAD,
	...
	C_L = BilinearInterpolation(C_L_arr[i][j], C_L_arr[i][j + 1], C_L_arr[i + 1][j], C_L_arr[i + 1][j + 1], Mach_arr[i], Mach_arr[i + 1], alpha_arr[j], alpha_arr[j + 1], Mach, alpha);
	C_D = BilinearInterpolation(C_D_arr[i][j], C_D_arr[i][j + 1], C_D_arr[i + 1][j], C_D_arr[i + 1][j + 1], Mach_arr[i], Mach_arr[i + 1], alpha_arr[j], alpha_arr[j + 1], Mach, alpha);

	//sprintf(oapiDebugString(), "Mach %lf alpha %lf i %d j %d C_M %lf C_L %lf C_D %lf", Mach, alpha*DEG, i, j, C_M, C_L, C_D);
}

void CMFreeFlowAero(double alpha, double &C_M, double &C_L, double &C_D)
{
	//Numbers from CSM Data Book, Table 5-4, converted to lift and drag coefficients
	...
	static const double C_L_free[] = { 0.0,-0.00377931,-0.00141585,-0.00789764,-0.0119936,-0.0100202,-0.00451905,-0.00300607,-0.000763152,0.0,
	0.000763152,-0.000414131,-0.000480947,0.00359232,-0.00209472,0.00289764,-0.00200435,0.00377931,0.0 };
	static const double C_D_free[] = { 2.02,1.97942,1.90436,1.77368,1.6478,1.5749,1.49217,1.39517,1.32019,1.29,1.32019,1.40456,1.50083,1.58256,1.64657,1.76502,1.89497,1.97942,2.01 };
	...
	C_L = C_L_free[i] + (C_L_free[i + 1] - C_L_free[i]) * f;
	C_D = C_D_free[i] + (C_D_free[i + 1] - C_D_free[i]) * f;
}
...
void CMVertCoeffFunc(VESSEL *v, double aoa, double M, double Re, void *context, double *cl, double *cm, double *cd)
{
	...
	double C_M_A, fact, C_L, C_D, cos_alpha, sin_alpha, alpha, phi_A, cos_phi_A;
	...
	if (Kn > 10.0)
	{
		CMFreeFlowAero(alpha, C_M_A, C_L, C_D);
	}
	else if (Kn < 0.01)
	{
		CMContinuumFlowAero(alpha, M, C_M_A, C_L, C_D);
	}
	else
	{
		double g = (Kn - 0.01) / 9.99;
		double C_M_A1, C_L1, C_D1, C_M_A2, C_L2, C_D2;
		CMFreeFlowAero(alpha, C_M_A1, C_L1, C_D1);
		CMContinuumFlowAero(alpha, M, C_M_A2, C_L2, C_D2);

		C_L = g * C_L1 + (1.0 - g)*C_L2;
		C_D = g * C_D1 + (1.0 - g)*C_D2;
...
void CMHorizCoeffFunc(VESSEL *v, double aoa, double M, double Re, void *context, double *cl, double *cm, double *cd)

{
	...
	double C_M_A, C_L, C_D, fact, cos_alpha, sin_alpha, alpha, phi_A, sin_phi_A;
