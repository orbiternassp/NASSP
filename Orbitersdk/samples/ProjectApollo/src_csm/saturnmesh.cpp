...
void CMContinuumFlowAero(double alpha, double Mach, double &C_M, double &C_A, double &C_NY)
{
	...
	static const double C_N_arr[16][26] = { {0,0.148,0.267,0.368,0.448,0.438,0.179,0.058,0.221,0.266,0.252,0.1926,0.1694,
	...
	static const double C_A_arr[16][26] = { {0.548,0.51,0.42,0.31,0.2,0.11,0.21,0.12,0.3,0.23,0.1,-0.1705,-0.2654,
