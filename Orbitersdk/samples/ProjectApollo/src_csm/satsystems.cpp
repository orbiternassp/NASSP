...
// Structure Temperature Debug Lines
	...
	sprintf(oapiDebugString(), "Volts: %.2f Temp: %.4f In Cabin: %d HX: %d", DockProbeTempSensor.Voltage(), KelvinToFahrenheit(*DockProbeTemp), dockingprobe.InCabin(), *DockProbeHX);
	//*/
