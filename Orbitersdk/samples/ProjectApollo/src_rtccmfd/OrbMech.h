...
namespace OrbMech {
	...
	VECTOR3 ThirdBodyConic(VECTOR3 R1, OBJHANDLE grav1, VECTOR3 R2, OBJHANDLE grav2, double mjd0, double dt, VECTOR3 V_guess, double tol = 0.1);
	...
	void LunarLiftoffTimePrediction(VECTOR3 R_LS, VECTOR3 R_P, VECTOR3 V_P, double MJD_P, double GETbase, OBJHANDLE hMoon, double t_L, double dt_1, double h_1, double theta_1, double dt_2, double v_LV, double v_LH, double DH, double E, double t_TPIguess, double dt_F, double &t_IG, double &t_CSI, double &t_CDH, double &t_TPF);
