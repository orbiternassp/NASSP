...
///*
	...
	double *Pump1Flow = (double*)Panelsdk.GetPointerByString("HYDRAULIC:PRIMGLYCOLPUMP1:FLOW");
	double *Pump2Flow = (double*)Panelsdk.GetPointerByString("HYDRAULIC:PRIMGLYCOLPUMP2:FLOW");
...
//*/
	...
	sprintf(oapiDebugString(), "AP %lf PMP %lf HXCP %lf L1P %lf HXLP %lf L2P %lf HXHP %lf EIP %lf EOP %lf ACP %lf DBP %lf 1 %lf 2 %lf 1out %lf 2out %lf", *primglycolpress*PSI, *glycolpumpmanifoldtpress*PSI, *glycolsuitcoolpress*PSI, *primloop1press*PSI, *waterglycolhxpress*PSI, *primloop2press*PSI, *glycolsuitheatpress*PSI, *primevapinpress*PSI, *primevapoutpress*PSI, *ascbatglycolpress*PSI, *desbatglycolpress*PSI, *Pump1Flow*LBH, *Pump2Flow*LBH, *Pump1OutFlow*LBH, *Pump2OutFlow*LBH);
