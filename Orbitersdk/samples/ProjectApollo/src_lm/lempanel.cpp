...
void LEM::InitSwitches() {
	...
	Panel12AntYawKnob.Register(PSH, "Panel12AntYawKnob", 5.2, 0.0, 12.0); //-12 degreesfor LM-5+, for now retain the 0-12 scaling of the bitmaps for checklist backwards compatibility
