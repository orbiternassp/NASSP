...
void LEM_FloodLights::SystemTimestep(double simdt)
{
	...
	FloodHeat->GenerateHeat((GetPowerDraw()*0.356)*0.70);	//Assumes linear relationship between heat and power draw based on maximum at 28V, 70% of power load to heat (just a guess!)
}