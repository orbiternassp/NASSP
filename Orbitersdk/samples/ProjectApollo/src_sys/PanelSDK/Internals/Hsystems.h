...
const double CRITICAL_P		[MAX_SUB]=  {350115.0,	89631.0,	1523741.0,	3300253.307024634,	508833.0,	3097574.75,		11692906.154,	10132500.0,		226968.0224 };		//Pa.. critical pressure
