/***************************************************************************
  ...
  *	Bugfix
  *	
  *	Revision 1.35  2008/04/11 11:58:12  tschachim
  *	Cleanup of e_object, DCBus and FuelCell.
  *	Fixed BasicExcel for VC6, reduced VS2005 warnings, bugfixes.
  *	
  *	Revision 1.34  2007/12/08 06:33:21  movieman523
  *	Doxygen added for transducer and voltage limited.
  *	
  *	Revision 1.33  2007/12/07 22:47:16  movieman523
  *	Added generic Transducer class, and derived VoltageAttenuator from it.
  *	
  *	Revision 1.32  2007/12/02 07:13:39  movieman523
  *	Updates for Apollo 5 and unmanned Saturn 1b missions.
  *	
  *	Revision 1.31  2007/11/30 16:40:40  movieman523
  ...
  *	
  *	Revision 1.30  2007/03/01 18:34:18  tschachim
  *	Fuel cells now can consume gaseous H2/O2.
  *	
  *	Revision 1.29  2007/01/14 13:02:41  dseagrav
  ...
  *	
  *	Revision 1.28  2006/12/19 15:56:13  tschachim
  *	ECS test stuff, bugfixes.
  *	
  *	Revision 1.27  2006/05/30 14:40:21  tschachim
  *	Fixed fuel cell - dc bus connectivity, added battery charger
  *	
  *	Revision 1.26  2006/05/19 13:48:28  tschachim
  *	Fixed a lot of devices and power consumptions.
  *	DirectO2 valve added.
  *	
  *	Revision 1.25  2006/05/15 22:01:49  movieman523
  *	Hopefully fixed crash, and removed unused library files.
  *	
  *	Revision 1.24  2006/02/19 01:50:25  tschachim
  *	Bugfix DCBus
  *	
  *	Revision 1.23  2006/01/14 18:57:48  movieman523
  *	First stages of pyro and SECS simulation.
  *	
  *	Revision 1.22  2006/01/08 21:43:34  movieman523
  *	First phase of implementing inverters, and stopped PanelSDK trying to delete objects which weren't allocated with new().
  *	
  *	Revision 1.21  2006/01/08 19:04:27  movieman523
  *	Wired up AC bus switches in a quick and hacky manner.
  *	
  *	Revision 1.20  2006/01/07 03:28:28  movieman523
  *	Removed a lot of unused switches and wired up the FDAI power switch.
  *	
  *	Revision 1.19  2006/01/07 00:43:58  movieman523
  *	Added non-essential buses, though there's nothing connected to them at the moment.
  *	
  *	Revision 1.18  2006/01/06 22:55:52  movieman523
  *	Fixed SM seperation and cut off fuel cell power when it happens.
  *	
  *	Revision 1.17  2005/12/30 22:41:48  movieman523
  *	More attempts to make code build on VC 2005.
  *	
  *	Revision 1.16  2005/12/19 17:40:19  tschachim
  *	Bugfixes.
  *	
  *	Revision 1.15  2005/12/02 19:29:24  movieman523
  *	Started integrating PowerSource code into PanelSDK.
  *	
  *	Revision 1.14  2005/11/24 01:07:54  movieman523
  *	Removed code for panel lights which were being set incorrectly. Plus a bit of tidying.
  *	
  *	Revision 1.13  2005/11/23 19:20:51  movieman523
  *	Made boilers work again!
  *	
  *	Revision 1.12  2005/11/18 22:11:22  movieman523
  *	Added seperate heat and electrical power usage for boilers. Revised cabin fan code.
  *	
  *	Revision 1.11  2005/11/18 20:38:59  movieman523
  *	Revised condensor output from fuel cell to eliminate master alarms.
  *	
  *	Revision 1.10  2005/11/18 02:40:54  movieman523
  *	Major revamp of PanelSDK electrical code, and various modifications to run off fuel cells.
  *	
  *	Revision 1.9  2005/11/17 22:06:47  movieman523
  *	Added other electrical buses and revised cabin fan code.
  *	
  *	Revision 1.8  2005/11/17 21:04:52  movieman523
  *	IMU and AGC now start powered-down. Revised battery code, and wired up all batteries in CSM.
  *	
  *	Revision 1.7  2005/09/30 11:18:48  tschachim
  *	New components for the water-glycol cooling.
  *	
  *	Revision 1.6  2005/07/30 16:15:46  tschachim
  *	Loading/saving Atmregen
  *	
  *	Revision 1.5  2005/07/19 16:49:26  tschachim
  *	Fuel cell purging
  *	
  *	Revision 1.4  2005/06/06 12:35:17  tschachim
  *	Bugfix FuelCell, saving/loading Cooling
  *	
  *	Revision 1.3  2005/05/26 16:09:52  tschachim
  *	Now boilers can heat all therm_objs, changed thermal behavior of fuel cells,
  *	introduced cooling bypass
  *	
  *	Revision 1.2  2005/05/02 12:57:59  tschachim
  *	bugfix fuel cell sources
  *	
