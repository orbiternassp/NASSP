...
void MCC::MissionSequence_H1()
{
	...
	case MST_H1_LUNAR_ORBIT_PDI_DAY_12: //Separation maneuver update to rev 13 map update
		UpdateMacro(UTP_PADONLY, PT_AP12SEPPAD, SubStateTime > 2.0 * 60.0, 37, MST_H1_LUNAR_ORBIT_PDI_DAY_13);
		break;
	...
	case MST_H1_LUNAR_ORBIT_PDI_DAY_17: //PDI Abort PAD to Lunar Surface PAD
		UpdateMacro(UTP_PADONLY, PT_AP12PDIABORTPAD, SubStateTime > 2.0 * 60.0, 71, MST_H1_LUNAR_ORBIT_PRE_DOI_1);
		break;
	case MST_H1_LUNAR_ORBIT_PRE_DOI_1: //Lunar Surface PAD to P22 Acquistion time
		UpdateMacro(UTP_PADONLY, PT_AP12LUNSURFPAD, SubStateTime > 2.0 * 60.0, 73, MST_H1_LUNAR_ORBIT_PRE_DOI_2);
		break;
	...
	case MST_H1_LUNAR_ORBIT_PRE_DOI_3: //LM SV update to rev 14 map update
		UpdateMacro(UTP_LGCUPLINKONLY, PT_NONE, SubStateTime > 3.0 * 60.0, 400, MST_H1_LUNAR_ORBIT_PRE_DOI_4);
		break;
	...
	case MST_H1_LUNAR_ORBIT_PRE_PDI_1: //Rev 15 map update to DOI Evaluation
		UpdateMacro(UTP_PADONLY, PT_AP10MAPUPDATE, mcc_calcs.GETEval(rtcc->calcParams.PDI - 20.0 * 60.0), 600, MST_H1_LUNAR_ORBIT_PRE_PDI_2);
		break;
	case MST_H1_LUNAR_ORBIT_PRE_PDI_2: //DOI Evaluation to SV and RLS uplink
		UpdateMacro(UTP_NONE, PT_NONE, true, 77, MST_H1_LUNAR_ORBIT_PRE_PDI_3);
		break;
	case MST_H1_LUNAR_ORBIT_PRE_PDI_3: //SV and RLS uplink to PDI Evaluation
		UpdateMacro(UTP_PADWITHLGCUPLINK, PT_GENERIC, mcc_calcs.GETEval(rtcc->calcParams.PDI + 2.0 * 60.0), 75, MST_H1_LUNAR_ORBIT_PRE_LANDING_1);
		break;
