...

{
 ...
 recursion = false;
	...
	case 1:
		...
		//oapiRegisterPanelArea (AID_DSKY_DISPLAY,				_R(1343,  959, 1420, 1090), PANEL_REDRAW_ALWAYS, PANEL_MOUSE_DOWN,PANEL_MAP_BACKGROUND);
		//oapiRegisterPanelArea (AID_DSKY_LIGHTS,				_R(1236,  963, 1310, 1051), PANEL_REDRAW_ALWAYS, PANEL_MOUSE_IGNORE, PANEL_MAP_BACKGROUND);
		oapiRegisterPanelArea (AID_DSKY_KEY,					_R(1183, 1157, 1471, 1278), PANEL_REDRAW_ALWAYS, PANEL_MOUSE_DOWN,PANEL_MAP_BACKGROUND);
		...
		oapiRegisterPanelArea (AID_MISSION_CLOCK,				_R( 908-835,  163, 1007-835,  178), PANEL_REDRAW_ALWAYS, PANEL_MOUSE_IGNORE,PANEL_MAP_BACKGROUND);
		...
		oapiRegisterPanelArea (AID_DSKY_DISPLAY,				_R(1343-835,  959, 1420-835, 1090), PANEL_REDRAW_ALWAYS, PANEL_MOUSE_DOWN,PANEL_MAP_BACKGROUND);
