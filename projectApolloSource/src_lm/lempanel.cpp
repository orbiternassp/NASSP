...
bool LEM::clbkLoadPanel (int id) {
	...
	case LMPANEL_MAIN: // LEM Main panel
		...
		oapiRegisterPanelArea (AID_MPS_REG_CONTROLS,				_R( 354,  918,  463, 1124), PANEL_REDRAW_ALWAYS, PANEL_MOUSE_DOWN|PANEL_MOUSE_UP, PANEL_MAP_BACKGROUND);
		...
		oapiRegisterPanelArea (AID_RCS_ASC_FEED_TALKBACKS,			_R( 807,  440, 1044,  463), PANEL_REDRAW_ALWAYS, PANEL_MOUSE_IGNORE,			  PANEL_MAP_BACKGROUND);
		oapiRegisterPanelArea (AID_RCS_ASC_FEED_SWITCHES,		    _R( 802,  493, 1050,  532), PANEL_REDRAW_ALWAYS, PANEL_MOUSE_DOWN|PANEL_MOUSE_UP, PANEL_MAP_BACKGROUND);
		oapiRegisterPanelArea (AID_RCS_LGC_CMD_ENABLE_14_TALKBACKS,	_R( 807,  589, 1044,  612), PANEL_REDRAW_ALWAYS, PANEL_MOUSE_IGNORE,			  PANEL_MAP_BACKGROUND);
		oapiRegisterPanelArea (AID_RCS_LGC_CMD_ENABLE_14_SWITCHES,	_R( 802,  642, 1050,  681), PANEL_REDRAW_ALWAYS, PANEL_MOUSE_DOWN|PANEL_MOUSE_UP, PANEL_MAP_BACKGROUND);
		oapiRegisterPanelArea (AID_RCS_LGC_CMD_ENABLE_23_TALKBACKS,	_R( 807,  715, 1044,  738), PANEL_REDRAW_ALWAYS, PANEL_MOUSE_IGNORE,			  PANEL_MAP_BACKGROUND);
		oapiRegisterPanelArea (AID_RCS_LGC_CMD_ENABLE_23_SWITCHES,	_R( 802,  768, 1050,  807), PANEL_REDRAW_ALWAYS, PANEL_MOUSE_DOWN|PANEL_MOUSE_UP, PANEL_MAP_BACKGROUND);
		oapiRegisterPanelArea (AID_RCS_XFEED_TALKBACK,				_R( 808,  871,  831,  894), PANEL_REDRAW_ALWAYS, PANEL_MOUSE_IGNORE,			  PANEL_MAP_BACKGROUND);
		oapiRegisterPanelArea (AID_RCS_XFEED_SWITCH,				_R( 802,  921,  836,  960), PANEL_REDRAW_ALWAYS, PANEL_MOUSE_DOWN|PANEL_MOUSE_UP, PANEL_MAP_BACKGROUND);
		...
		oapiRegisterPanelArea (AID_ENGGIMBALENABLESWITCH,			_R( 101, 1227,  135, 1268), PANEL_REDRAW_ALWAYS, PANEL_MOUSE_DOWN,				  PANEL_MAP_BACKGROUND);
		...
		oapiRegisterPanelArea (AID_LMRADARSLEWSWITCH,			    _R( 269, 1433,  310, 1472), PANEL_REDRAW_ALWAYS, PANEL_MOUSE_DOWN|PANEL_MOUSE_UP, PANEL_MAP_BACKGROUND);
		oapiRegisterPanelArea (AID_LM_EVENT_TIMER_SWITCHES,			_R( 915, 1233, 1116, 1264), PANEL_REDRAW_ALWAYS, PANEL_MOUSE_DOWN|PANEL_MOUSE_UP, PANEL_MAP_BACKGROUND);
	...
	case LMPANEL_LEFTPANEL: // LEM Left Panel
		...
		oapiRegisterPanelArea (AID_LEM_PANEL_5,					    _R( 1000,1300, 1560, 1620), PANEL_REDRAW_ALWAYS, PANEL_MOUSE_DOWN|PANEL_MOUSE_UP, PANEL_MAP_BACKGROUND);		
	...
	case LMPANEL_RIGHTPANEL: // LEM Right Panel
		...
		oapiRegisterPanelArea (AID_LEM_P16_CB_ROW1,					_R( 173,  85,  1415, 118), PANEL_REDRAW_ALWAYS, PANEL_MOUSE_DOWN,				 PANEL_MAP_BACKGROUND);
		oapiRegisterPanelArea (AID_LEM_P16_CB_ROW2,					_R( 173,  258, 1415, 290), PANEL_REDRAW_ALWAYS, PANEL_MOUSE_DOWN,				 PANEL_MAP_BACKGROUND);
		oapiRegisterPanelArea (AID_LEM_P16_CB_ROW3,					_R( 173,  431, 1415, 462), PANEL_REDRAW_ALWAYS, PANEL_MOUSE_DOWN,				 PANEL_MAP_BACKGROUND);
		...
		oapiRegisterPanelArea (AID_LM_P12_COMM_SWITCHES_ROW3,		_R( 636, 1189,  926, 1270), PANEL_REDRAW_ALWAYS, PANEL_MOUSE_DOWN,				 PANEL_MAP_BACKGROUND);
...
void LEM::SetSwitches(int panel) {
	...
	switch(panel){
		case LMPANEL_MAIN:
			...
			// 354,  918,  463, 1124
			MPSRegControlSwitchRow.Init(AID_MPS_REG_CONTROLS, MainPanel);
			ASCHeReg1TB.Init( 6,   0, 23, 23, srf[SRF_INDICATOR], MPSRegControlSwitchRow);
			ASCHeReg2TB.Init(80,   0, 23, 23, srf[SRF_INDICATOR], MPSRegControlSwitchRow);
			DESHeReg1TB.Init( 7, 134, 23, 23, srf[SRF_INDICATOR], MPSRegControlSwitchRow);
			DESHeReg2TB.Init(81, 134, 23, 23, srf[SRF_INDICATOR], MPSRegControlSwitchRow);
			ASCHeReg1Switch.Init( 0,    43, 34, 29, srf[SRF_LMTHREEPOSSWITCH], srf[SRF_BORDER_34x29], MPSRegControlSwitchRow);
			ASCHeReg2Switch.Init( 74,   43, 34, 29, srf[SRF_LMTHREEPOSSWITCH], srf[SRF_BORDER_34x29], MPSRegControlSwitchRow);
			DESHeReg1Switch.Init( 1,   177, 34, 29, srf[SRF_LMTHREEPOSSWITCH], srf[SRF_BORDER_34x29], MPSRegControlSwitchRow);
			DESHeReg2Switch.Init( 75,  177, 34, 29, srf[SRF_LMTHREEPOSSWITCH], srf[SRF_BORDER_34x29], MPSRegControlSwitchRow);
			...
			RCSAscFeed2ASwitch.Init( 70,  0, 34, 39, srf[SRF_LMTHREEPOSLEVER], srf[SRF_BORDER_34x39], RCSAscFeedSwitchRow);
			RCSAscFeed1BSwitch.Init(144,  0, 34, 39, srf[SRF_LMTHREEPOSLEVER], srf[SRF_BORDER_34x39], RCSAscFeedSwitchRow);
			RCSAscFeed2BSwitch.Init(214,  0, 34, 39, srf[SRF_LMTHREEPOSLEVER], srf[SRF_BORDER_34x39], RCSAscFeedSwitchRow);
			...
			RCSQuad4ACmdEnableSwitch.Init( 70,  0, 34, 39, srf[SRF_LMTHREEPOSLEVER], srf[SRF_BORDER_34x39], RCSQuad14SwitchRow);
			RCSQuad1BCmdEnableSwitch.Init(144,  0, 34, 39, srf[SRF_LMTHREEPOSLEVER], srf[SRF_BORDER_34x39], RCSQuad14SwitchRow);
			RCSQuad4BCmdEnableSwitch.Init(214,  0, 34, 39, srf[SRF_LMTHREEPOSLEVER], srf[SRF_BORDER_34x39], RCSQuad14SwitchRow);
			...
			RCSQuad3ACmdEnableSwitch.Init( 70,  0, 34, 39, srf[SRF_LMTHREEPOSLEVER], srf[SRF_BORDER_34x39], RCSQuad23SwitchRow);
			RCSQuad2BCmdEnableSwitch.Init(144,  0, 34, 39, srf[SRF_LMTHREEPOSLEVER], srf[SRF_BORDER_34x39], RCSQuad23SwitchRow);
			RCSQuad3BCmdEnableSwitch.Init(214,  0, 34, 39, srf[SRF_LMTHREEPOSLEVER], srf[SRF_BORDER_34x39], RCSQuad23SwitchRow);
		...
		case LMPANEL_RIGHTPANEL: // LEM Right Panel
			...
			LMPAudSBandVol.Init(4, 61, 25, 77, srf[SRF_THUMBWHEEL_LARGEFONTSINV], NULL, Panel12AudioControlSwitchRow); // FIXME: Need flashing border for this
			LMPAudICSVol.Init(108, 61, 25, 77, srf[SRF_THUMBWHEEL_LARGEFONTSINV], NULL, Panel12AudioControlSwitchRow);
			LMPAudVOXSwitch.Init(206, 79, 34, 29, srf[SRF_LMTHREEPOSSWITCH], srf[SRF_BORDER_34x29], Panel12AudioControlSwitchRow);
			...
			LMPAudVOXSens.Init(210, 132, 25, 77, srf[SRF_THUMBWHEEL_LARGEFONTSINV], NULL, Panel12AudioControlSwitchRow);
			LMPAudVHFAVol.Init(4, 221, 25, 77, srf[SRF_THUMBWHEEL_LARGEFONTSINV], NULL, Panel12AudioControlSwitchRow);
			LMPAudVHFBVol.Init(108, 221, 25, 77, srf[SRF_THUMBWHEEL_LARGEFONTSINV], NULL, Panel12AudioControlSwitchRow);
			LMPAudMasterVol.Init(210, 221, 25, 77, srf[SRF_THUMBWHEEL_LARGEFONTSINV], NULL, Panel12AudioControlSwitchRow);
			...
			VHFASquelch.Init(0, 0, 25, 77, srf[SRF_THUMBWHEEL_LARGEFONTSINV], NULL, Panel12CommSwitchRow3);
			VHFBSquelch.Init(772-636, 0, 25, 77, srf[SRF_THUMBWHEEL_LARGEFONTSINV], NULL, Panel12CommSwitchRow3);
		...
		case LMPANEL_LEFTPANEL:
			...
			LMP_FDAI_AC_CB.Init(445, 0, 29, 29, srf[SRF_CIRCUITBRAKER], srf[SRF_BORDER_29x29], Panel11CB1SwitchRow, &ACBusB, 2.0);
			...
			HTR_RR_STBY_CB.Init( 66, 0, 29, 29, srf[SRF_CIRCUITBRAKER], srf[SRF_BORDER_29x29], Panel11CB3SwitchRow, &CDRs28VBus, 7.5);
			HTR_LR_CB.Init(194, 0, 29, 29, srf[SRF_CIRCUITBRAKER], srf[SRF_BORDER_29x29], Panel11CB3SwitchRow, &CDRs28VBus, 5.0);
			INST_SIG_CONDR_1_CB.Init(445, 0, 29, 29, srf[SRF_CIRCUITBRAKER], srf[SRF_BORDER_29x29], Panel11CB3SwitchRow, &CDRs28VBus, 2.0);
			...
			CDR_LTG_UTIL_CB.Init(1149, 0, 29, 29, srf[SRF_CIRCUITBRAKER], srf[SRF_BORDER_29x29], Panel11CB3SwitchRow, &CDRs28VBus, 2.0);
			CDR_LTG_ANUN_DOCK_COMPNT_CB.Init(1213, 0, 29, 29, srf[SRF_CIRCUITBRAKER], srf[SRF_BORDER_29x29], Panel11CB3SwitchRow, &CDRs28VBus, 2.0);

			Panel11CB4SwitchRow.Init(AID_LEM_P11_CB_ROW4, MainPanel);
			ECS_GLYCOL_PUMP_2_CB.Init(445, 0, 29, 29, srf[SRF_CIRCUITBRAKER], srf[SRF_BORDER_29x29], Panel11CB4SwitchRow, &CDRs28VBus, 5.0);
			COMM_SEC_SBAND_XCVR_CB.Init( 701, 0, 29, 29, srf[SRF_CIRCUITBRAKER], srf[SRF_BORDER_29x29], Panel11CB4SwitchRow, &CDRs28VBus, 5.0);
			COMM_SEC_SBAND_PA_CB.Init( 765, 0, 29, 29, srf[SRF_CIRCUITBRAKER], srf[SRF_BORDER_29x29], Panel11CB4SwitchRow, &CDRs28VBus, 7.5);
			COMM_VHF_XMTR_B_CB.Init(829, 0, 29, 29, srf[SRF_CIRCUITBRAKER], srf[SRF_BORDER_29x29], Panel11CB4SwitchRow, &CDRs28VBus, 5.0);
			COMM_VHF_RCVR_A_CB.Init( 893, 0, 29, 29, srf[SRF_CIRCUITBRAKER], srf[SRF_BORDER_29x29], Panel11CB4SwitchRow, &CDRs28VBus, 2.0);
			COMM_CDR_AUDIO_CB.Init( 957, 0, 29, 29, srf[SRF_CIRCUITBRAKER], srf[SRF_BORDER_29x29], Panel11CB4SwitchRow, &CDRs28VBus, 2.0);
			...
			CDRBatteryFeedTieCB1.Init(  2,  0, 29, 29, srf[SRF_CIRCUITBRAKER], srf[SRF_BORDER_29x29], Panel11CB5SwitchRow, &BTB_CDR_B, 100.0);
			CDRBatteryFeedTieCB2.Init( 66,  0, 29, 29, srf[SRF_CIRCUITBRAKER], srf[SRF_BORDER_29x29], Panel11CB5SwitchRow, &BTB_CDR_C, 100.0);
			...
			CDRAudioControlSwitch.Init(1477-431, 1017-916, 34, 29,srf[SRF_SWITCHUP], srf[SRF_BORDER_34x29], Panel8SwitchRow);
			...
			CDRAudSBandVol.Init(1190-431, 1008-916, 25, 77, srf[SRF_THUMBWHEEL_LARGEFONTSINV], NULL, Panel8SwitchRow); // FIXME: Need flashing border for this
			CDRAudVHFAVol.Init(1190-431, 1175-916, 25, 77, srf[SRF_THUMBWHEEL_LARGEFONTSINV], NULL, Panel8SwitchRow);
			CDRAudVHFBVol.Init(1289-431, 1175-916, 25, 77, srf[SRF_THUMBWHEEL_LARGEFONTSINV], NULL, Panel8SwitchRow);
			CDRAudICSVol.Init(1289-431, 1008-916, 25, 77, srf[SRF_THUMBWHEEL_LARGEFONTSINV], NULL, Panel8SwitchRow);
			CDRAudMasterVol.Init(1394-431, 1175-916, 25, 77, srf[SRF_THUMBWHEEL_LARGEFONTSINV], NULL, Panel8SwitchRow);
			CDRAudVOXSens.Init(1394-431, 1076-916, 25, 77, srf[SRF_THUMBWHEEL_LARGEFONTSINV], NULL, Panel8SwitchRow);
			CDRCOASSwitch.Init(1494-431, 1187-916, 34, 29, srf[SRF_LMTHREEPOSSWITCH], srf[SRF_BORDER_34x29], Panel8SwitchRow);
