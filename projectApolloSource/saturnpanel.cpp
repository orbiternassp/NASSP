...

{
	...
	case 0:
//		if (!hBmpLit)
			hBmpLit = LoadBitmap (g_Param.hDLL, MAKEINTRESOURCE (IDB_ILMPANEL));
		hBmp = hBmpLit;
	...
	case 1:
//		if (!hBmpFlat)
			hBmpFlat = LoadBitmap (g_Param.hDLL, MAKEINTRESOURCE (IDB_MAINPANEL));
		hBmp = hBmpFlat;
		oapiSetPanelNeighbours(-1, 0, 3, -1);
		break;

	case 2:
//		if (!hBmpDckLit)
			hBmpDckLit = LoadBitmap (g_Param.hDLL, MAKEINTRESOURCE (IDB_ILMDCKPANEL));
		hBmp = hBmpDckLit;
		oapiSetPanelNeighbours(3, -1, -1, 0);
		break;

	case 3:
//		if (!hBmpDckFlat)
			hBmpDckFlat = LoadBitmap (g_Param.hDLL, MAKEINTRESOURCE (IDB_MAINDCKPANEL));
		hBmp = hBmpDckFlat;
		oapiSetPanelNeighbours(-1, 2, -1, 1);
		break;
	...
	case 1: // ilm panel
		...
		oapiRegisterPanelArea (AID_ALTITUDE1,							_R( 547, 385,  643,  400), PANEL_REDRAW_ALWAYS, PANEL_MOUSE_IGNORE,PANEL_MAP_BACKGROUND);
		oapiRegisterPanelArea (AID_ALTIMETER,							_R( 626,  69,  717,  159), PANEL_REDRAW_ALWAYS, PANEL_MOUSE_IGNORE,PANEL_MAP_BACKGROUND);
		oapiRegisterPanelArea (AID_CLOCK,								_R(1370, 226, 1460,  241), PANEL_REDRAW_ALWAYS, PANEL_MOUSE_IGNORE,PANEL_MAP_BACKGROUND);
		oapiRegisterPanelArea (AID_MASTER_ALARM,						_R( 345, 369,  378,  396), PANEL_REDRAW_ALWAYS, PANEL_MOUSE_DOWN);
		oapiRegisterPanelArea (AID_MASTER_ALARM,						_R(2199, 484, 2232,  511), PANEL_REDRAW_ALWAYS, PANEL_MOUSE_DOWN);
		oapiRegisterPanelArea (AID_GMETER,                              _R( 301, 451,  357,  508), PANEL_REDRAW_ALWAYS, PANEL_MOUSE_DOWN,PANEL_MAP_BACKGROUND);
		oapiRegisterPanelArea (AID_HORIZON,								_R( 853, 254,  949,  350), PANEL_REDRAW_ALWAYS, PANEL_MOUSE_IGNORE);
		oapiRegisterPanelArea (AID_HORIZON2,							_R( 440, 497,  536,  593), PANEL_REDRAW_ALWAYS, PANEL_MOUSE_IGNORE);
		oapiRegisterPanelArea (AID_P11_SWITCH,							_R( 256, 472,  279,  492), PANEL_REDRAW_ALWAYS, PANEL_MOUSE_DOWN,PANEL_MAP_BACKGROUND);
		oapiRegisterPanelArea (AID_SWITCH_HUD,                          _R( 194, 545,  329,  577), PANEL_REDRAW_ALWAYS, PANEL_MOUSE_DOWN,PANEL_MAP_BACKGROUND);
		oapiRegisterPanelArea (AID_SM_RCS_PANEL1,                       _R( 138, 616,  232,  649), PANEL_REDRAW_ALWAYS, PANEL_MOUSE_DOWN,PANEL_MAP_BACKGROUND);
		oapiRegisterPanelArea (AID_P12_SWITCH,							_R( 332, 545,  361,  577), PANEL_REDRAW_ALWAYS, PANEL_MOUSE_DOWN,PANEL_MAP_BACKGROUND);
		oapiRegisterPanelArea (AID_P13,							        _R( 234, 616,  295,  649), PANEL_REDRAW_ALWAYS, PANEL_MOUSE_DOWN,PANEL_MAP_BACKGROUND);
		oapiRegisterPanelArea (AID_SM_RCS_MODE,                         _R( 298, 616,  360,  649), PANEL_REDRAW_ALWAYS, PANEL_MOUSE_DOWN,PANEL_MAP_BACKGROUND);
		oapiRegisterPanelArea (AID_SPS_GIMBAL_SWITCHES,                 _R( 343, 865,  487,  897), PANEL_REDRAW_ALWAYS, PANEL_MOUSE_DOWN,PANEL_MAP_BACKGROUND);
		oapiRegisterPanelArea (AID_TLI_SWITCH,							_R( 847, 863,  870,  883), PANEL_REDRAW_ALWAYS, PANEL_MOUSE_DOWN,PANEL_MAP_BACKGROUND);
		oapiRegisterPanelArea (AID_SPS,									_R( 221, 781,  251,  820), PANEL_REDRAW_ALWAYS, PANEL_MOUSE_DOWN,PANEL_MAP_BACKGROUND);
		oapiRegisterPanelArea (AID_CM_RCS_SWITCH,                       _R(1112, 424, 1137,  469), PANEL_REDRAW_ALWAYS, PANEL_MOUSE_DOWN,PANEL_MAP_BACKGROUND);
		oapiRegisterPanelArea (AID_CMC_SWITCH,                          _R( 318, 705,  342,  725), PANEL_REDRAW_ALWAYS, PANEL_MOUSE_DOWN,PANEL_MAP_BACKGROUND);
		oapiRegisterPanelArea (AID_SC_SWITCH,                           _R( 285, 705,  308,  725), PANEL_REDRAW_ALWAYS, PANEL_MOUSE_DOWN,PANEL_MAP_BACKGROUND);
		oapiRegisterPanelArea (AID_DVA_SWITCH,                          _R( 328, 782,  353,  827), PANEL_REDRAW_ALWAYS, PANEL_MOUSE_DOWN,PANEL_MAP_BACKGROUND);
		oapiRegisterPanelArea (AID_DVB_SWITCH,                          _R( 400, 782,  425,  827), PANEL_REDRAW_ALWAYS, PANEL_MOUSE_DOWN,PANEL_MAP_BACKGROUND);
		oapiRegisterPanelArea (AID_P16,									_R(  75, 699,  191,  730), PANEL_REDRAW_ALWAYS, PANEL_MOUSE_DOWN,PANEL_MAP_BACKGROUND);
		oapiRegisterPanelArea (AID_SIVB_RCS,                            _R(  94, 770,  190,  790), PANEL_REDRAW_ALWAYS, PANEL_MOUSE_DOWN,PANEL_MAP_BACKGROUND);
		oapiRegisterPanelArea (AID_ROT_PWR,								_R( 216, 705,  239,  725), PANEL_REDRAW_ALWAYS, PANEL_MOUSE_DOWN,PANEL_MAP_BACKGROUND);
		oapiRegisterPanelArea (AID_SIVB_GIMBAL,                         _R( 284, 872,  338,  892), PANEL_REDRAW_ALWAYS, PANEL_MOUSE_DOWN,PANEL_MAP_BACKGROUND);
		oapiRegisterPanelArea (AID_P17,                                 _R( 523, 872,  546,  892), PANEL_REDRAW_ALWAYS, PANEL_MOUSE_DOWN,PANEL_MAP_BACKGROUND);
		oapiRegisterPanelArea (AID_ELS_SWITCH,                          _R( 554, 859,  579,  904), PANEL_REDRAW_ALWAYS, PANEL_MOUSE_DOWN,PANEL_MAP_BACKGROUND);
		oapiRegisterPanelArea (AID_P18,                                 _R( 588, 872,  611,  892), PANEL_REDRAW_ALWAYS, PANEL_MOUSE_DOWN,PANEL_MAP_BACKGROUND);
		oapiRegisterPanelArea (AID_CM_RCS_LOGIC,                        _R( 616, 865,  645,  897), PANEL_REDRAW_ALWAYS, PANEL_MOUSE_DOWN,PANEL_MAP_BACKGROUND);
		oapiRegisterPanelArea (AID_CMD_SWITCH,                          _R( 651, 859,  676,  904), PANEL_REDRAW_ALWAYS, PANEL_MOUSE_DOWN,PANEL_MAP_BACKGROUND);
		oapiRegisterPanelArea (AID_CMP_SWITCH,                          _R( 684, 859,  709,  904), PANEL_REDRAW_ALWAYS, PANEL_MOUSE_DOWN,PANEL_MAP_BACKGROUND);
		oapiRegisterPanelArea (AID_IMU_SWITCH,                          _R( 215, 924,  240,  969), PANEL_REDRAW_ALWAYS, PANEL_MOUSE_DOWN,PANEL_MAP_BACKGROUND);
		oapiRegisterPanelArea (AID_FCSM_SWITCH,                         _R( 515, 930,  584,  964), PANEL_REDRAW_ALWAYS, PANEL_MOUSE_DOWN,PANEL_MAP_BACKGROUND);
		oapiRegisterPanelArea (AID_P19,                                 _R( 247, 930,  436,  962), PANEL_REDRAW_ALWAYS, PANEL_MOUSE_DOWN,PANEL_MAP_BACKGROUND);
		oapiRegisterPanelArea (AID_DIRECT_ULLAGE_THRUST_ON_LIGHT,		_R( 273, 768,  303,  838), PANEL_REDRAW_ALWAYS, PANEL_MOUSE_DOWN,PANEL_MAP_BACKGROUND);
		oapiRegisterPanelArea (AID_LV_ENGINE_INDICATOR,					_R( 626, 546,  701,  653), PANEL_REDRAW_ALWAYS, PANEL_MOUSE_DOWN,PANEL_MAP_BACKGROUND);
		oapiRegisterPanelArea (AID_LIGHTS_LAUNCHER,						_R( 612, 687,  718,  777), PANEL_REDRAW_ALWAYS, PANEL_MOUSE_DOWN,PANEL_MAP_BACKGROUND);
		oapiRegisterPanelArea (AID_LV_TANK_GAUGES,                      _R( 466, 688,  589,  767), PANEL_REDRAW_ALWAYS, PANEL_MOUSE_DOWN,PANEL_MAP_BACKGROUND);
		oapiRegisterPanelArea (AID_DSKY,								_R( 920, 435,  997,  566), PANEL_REDRAW_ALWAYS, PANEL_MOUSE_DOWN,PANEL_MAP_BACKGROUND);
		oapiRegisterPanelArea (AID_DSKY_LIGHTS,							_R( 813, 439,  887,  527), PANEL_REDRAW_ALWAYS, PANEL_MOUSE_IGNORE, PANEL_MAP_BACKGROUND);
		oapiRegisterPanelArea (AID_GDC_BUTTON,                          _R( 217, 869,  243,  895), PANEL_REDRAW_ALWAYS, PANEL_MOUSE_DOWN,PANEL_MAP_BACKGROUND);
		oapiRegisterPanelArea (AID_THRUSTMETER,                         _R( 374, 687,  436,  747), PANEL_REDRAW_ALWAYS, PANEL_MOUSE_IGNORE,PANEL_MAP_BACKGROUND);
		oapiRegisterPanelArea (AID_ABORT_BUTTON,						_R( 639, 444,  688,  470), PANEL_REDRAW_ALWAYS, PANEL_MOUSE_DOWN,PANEL_MAP_BACKGROUND);
		oapiRegisterPanelArea (AID_DSKY_KEY,                            _R( 799, 582, 1010,  671), PANEL_REDRAW_ALWAYS, PANEL_MOUSE_DOWN,PANEL_MAP_BACKGROUND);
		oapiRegisterPanelArea (AID_SWITCH_JET,                          _R( 841, 699,  964,  744), PANEL_REDRAW_ALWAYS, PANEL_MOUSE_DOWN,PANEL_MAP_BACKGROUND);
		oapiRegisterPanelArea (AID_EDS,                                 _R( 808, 712,  831,  732), PANEL_REDRAW_ALWAYS, PANEL_MOUSE_DOWN,PANEL_MAP_BACKGROUND);
		oapiRegisterPanelArea (AID_ABORT_ROW,                           _R( 771, 775,  882,  804), PANEL_REDRAW_ALWAYS, PANEL_MOUSE_DOWN,PANEL_MAP_BACKGROUND);
		oapiRegisterPanelArea (AID_MAIN_RELEASE_SWITCH,                 _R( 774, 917,  799,  963), PANEL_REDRAW_ALWAYS, PANEL_MOUSE_DOWN,PANEL_MAP_BACKGROUND);
		oapiRegisterPanelArea (AID_TOWER_JET_SWITCH1,                   _R( 900, 768,  925,  813), PANEL_REDRAW_ALWAYS, PANEL_MOUSE_DOWN,PANEL_MAP_BACKGROUND);
		oapiRegisterPanelArea (AID_TOWER_JET_SWITCH2,                   _R( 934, 768,  959,  813), PANEL_REDRAW_ALWAYS, PANEL_MOUSE_DOWN,PANEL_MAP_BACKGROUND);
		oapiRegisterPanelArea (AID_IU_GUIDANCE_SWITCH,                  _R( 776, 850,  801,  895), PANEL_REDRAW_ALWAYS, PANEL_MOUSE_DOWN,PANEL_MAP_BACKGROUND);
		oapiRegisterPanelArea (AID_LV_STAGE_SWITCH,						_R( 810, 850,  835,  895), PANEL_REDRAW_ALWAYS, PANEL_MOUSE_DOWN,PANEL_MAP_BACKGROUND);
		oapiRegisterPanelArea (AID_DOCKING_PROBE_SWITCH,				_R(1029, 131, 1055,  240), PANEL_REDRAW_ALWAYS, PANEL_MOUSE_DOWN,PANEL_MAP_BACKGROUND);
		oapiRegisterPanelArea (AID_P21,                                 _R(1061, 201, 1236,  233), PANEL_REDRAW_ALWAYS, PANEL_MOUSE_DOWN,PANEL_MAP_BACKGROUND);
		oapiRegisterPanelArea (AID_CSM_SIVB_SEP_SWITCH,                 _R( 595, 785,  664,  816), PANEL_REDRAW_ALWAYS, PANEL_MOUSE_DOWN,PANEL_MAP_BACKGROUND);
		oapiRegisterPanelArea (AID_LEM_POWER_SWITCH,					_R(1258, 208, 1281,  228), PANEL_REDRAW_ALWAYS, PANEL_MOUSE_DOWN,PANEL_MAP_BACKGROUND);
		oapiRegisterPanelArea (AID_SIVB_LEM_SEP_SWITCH,					_R( 968, 699,  994,  745), PANEL_REDRAW_ALWAYS, PANEL_MOUSE_DOWN,PANEL_MAP_BACKGROUND);
		oapiRegisterPanelArea (AID_SMRCS_HELIUM1_SWITCHES,				_R(1175, 271, 1297,  345), PANEL_REDRAW_ALWAYS, PANEL_MOUSE_DOWN,PANEL_MAP_BACKGROUND);
		oapiRegisterPanelArea (AID_P22,									_R(1045, 430, 1106,  461), PANEL_REDRAW_ALWAYS, PANEL_MOUSE_DOWN,PANEL_MAP_BACKGROUND);
		oapiRegisterPanelArea (AID_P23,									_R(1146, 436, 1169,  457), PANEL_REDRAW_ALWAYS, PANEL_MOUSE_DOWN,PANEL_MAP_BACKGROUND);
		oapiRegisterPanelArea (AID_SMRCS_HELIUM2_SWITCHES,				_R(1175, 388, 1300,  461), PANEL_REDRAW_ALWAYS, PANEL_MOUSE_DOWN,PANEL_MAP_BACKGROUND);
		oapiRegisterPanelArea (AID_PRIM_PRPLNT_SWITCHES,				_R(1175, 487, 1300,  559), PANEL_REDRAW_ALWAYS, PANEL_MOUSE_DOWN,PANEL_MAP_BACKGROUND);
		oapiRegisterPanelArea (AID_P24,									_R(1047, 527, 1172,  559), PANEL_REDRAW_ALWAYS, PANEL_MOUSE_DOWN,PANEL_MAP_BACKGROUND);
		oapiRegisterPanelArea (AID_P25,									_R(1047, 624, 1108,  655), PANEL_REDRAW_ALWAYS, PANEL_MOUSE_DOWN,PANEL_MAP_BACKGROUND);
		oapiRegisterPanelArea (AID_SEC_PRPLT_SWITCHES,					_R(1111, 586, 1300,  655), PANEL_REDRAW_ALWAYS, PANEL_MOUSE_DOWN,PANEL_MAP_BACKGROUND);
		oapiRegisterPanelArea (AID_CAUTION_PANEL,						_R(1420, 291, 1553,  323), PANEL_REDRAW_ALWAYS, PANEL_MOUSE_DOWN,PANEL_MAP_BACKGROUND);
		oapiRegisterPanelArea (AID_P27,									_R(1502, 358, 1848,  389), PANEL_REDRAW_ALWAYS, PANEL_MOUSE_DOWN,PANEL_MAP_BACKGROUND);
		oapiRegisterPanelArea (AID_P28,									_R(1324, 546, 1625,  655), PANEL_REDRAW_ALWAYS, PANEL_MOUSE_DOWN,PANEL_MAP_BACKGROUND);
		oapiRegisterPanelArea (AID_P29,									_R(1620, 695, 1681,  726), PANEL_REDRAW_ALWAYS, PANEL_MOUSE_DOWN,PANEL_MAP_BACKGROUND);
		oapiRegisterPanelArea (AID_P30,									_R(1766, 854, 1827,  885), PANEL_REDRAW_ALWAYS, PANEL_MOUSE_DOWN,PANEL_MAP_BACKGROUND);
		oapiRegisterPanelArea (AID_CABIN_PRESS,							_R(1629, 624, 1729,  655), PANEL_REDRAW_ALWAYS, PANEL_MOUSE_DOWN,PANEL_MAP_BACKGROUND);
		oapiRegisterPanelArea (AID_FUEL_CELL_RADIATORS,					_R(2089, 398, 2182,  476), PANEL_REDRAW_ALWAYS, PANEL_MOUSE_DOWN,PANEL_MAP_BACKGROUND);
		oapiRegisterPanelArea (AID_P31,									_R(2090, 510, 2181,  632), PANEL_REDRAW_ALWAYS, PANEL_MOUSE_DOWN,PANEL_MAP_BACKGROUND);
		oapiRegisterPanelArea (AID_FUEL_CELL_BUS_SWITCHES,				_R(2184, 561, 2288,  632), PANEL_REDRAW_ALWAYS, PANEL_MOUSE_DOWN,PANEL_MAP_BACKGROUND);
		oapiRegisterPanelArea (AID_P32,									_R(2294, 608, 2317,  628), PANEL_REDRAW_ALWAYS, PANEL_MOUSE_DOWN,PANEL_MAP_BACKGROUND);
		oapiRegisterPanelArea (AID_SPS_HELIUM_SWITCHES,					_R(1923, 663, 1984,  735), PANEL_REDRAW_ALWAYS, PANEL_MOUSE_DOWN,PANEL_MAP_BACKGROUND);
		oapiRegisterPanelArea (AID_P33,									_R(1987, 703, 2074,  735), PANEL_REDRAW_ALWAYS, PANEL_MOUSE_DOWN,PANEL_MAP_BACKGROUND);
		oapiRegisterPanelArea (AID_P34,									_R(2301, 710, 2324,  730), PANEL_REDRAW_ALWAYS, PANEL_MOUSE_DOWN,PANEL_MAP_BACKGROUND);
		oapiRegisterPanelArea (AID_FUEL_CELL_SWITCHES,					_R(2077, 661, 2285,  735), PANEL_REDRAW_ALWAYS, PANEL_MOUSE_DOWN,PANEL_MAP_BACKGROUND);
		oapiRegisterPanelArea (AID_P35,									_R(1923, 774, 2281,  881), PANEL_REDRAW_ALWAYS, PANEL_MOUSE_DOWN,PANEL_MAP_BACKGROUND);
		oapiRegisterPanelArea (AID_P36,									_R(1923, 923, 2326,  954), PANEL_REDRAW_ALWAYS, PANEL_MOUSE_DOWN,PANEL_MAP_BACKGROUND);
		oapiRegisterPanelArea (AID_CABIN_FAN_SWITCHES,					_R(1417, 358, 1490,  390), PANEL_REDRAW_ALWAYS, PANEL_MOUSE_DOWN,PANEL_MAP_BACKGROUND);
		oapiRegisterPanelArea (AID_CW,									_R(1141,  69, 1490,  154), PANEL_REDRAW_ALWAYS, PANEL_MOUSE_IGNORE,PANEL_MAP_BACKGROUND);
		oapiRegisterPanelArea (AID_SMRCS_FUEL,                          _R(1034, 288, 1146,  377), PANEL_REDRAW_ALWAYS, PANEL_MOUSE_DOWN,PANEL_MAP_BACKGROUND);
		oapiRegisterPanelArea (AID_SPS_FUEL,                            _R(1920, 239, 2027,  327), PANEL_REDRAW_ALWAYS, PANEL_MOUSE_DOWN,PANEL_MAP_BACKGROUND);
		oapiRegisterPanelArea (AID_EMS_SWITCH,							_R( 437, 293,  467,  324), PANEL_REDRAW_ALWAYS, PANEL_MOUSE_DOWN,PANEL_MAP_BACKGROUND);
		oapiRegisterPanelArea (AID_BUS_PANEL,							_R(2361, 774, 2488,  954), PANEL_REDRAW_ALWAYS, PANEL_MOUSE_DOWN,PANEL_MAP_BACKGROUND);
		oapiRegisterPanelArea (AID_05G_LIGHT,							_R( 561, 347,  585,  361), PANEL_REDRAW_ALWAYS, PANEL_MOUSE_IGNORE,PANEL_MAP_BACKGROUND);
		oapiRegisterPanelArea (AID_SPS_LIGHT,							_R( 604, 347,  628,  361), PANEL_REDRAW_ALWAYS, PANEL_MOUSE_IGNORE,PANEL_MAP_BACKGROUND);
		oapiRegisterPanelArea (AID_SPS_INJ_VLV,							_R(1924, 385, 2065,  417), PANEL_REDRAW_ALWAYS, PANEL_MOUSE_IGNORE,PANEL_MAP_BACKGROUND);
		oapiRegisterPanelArea (AID_AUTO_LIGHT,							_R( 464, 929,  480,  945), PANEL_REDRAW_ALWAYS, PANEL_MOUSE_IGNORE,PANEL_MAP_BACKGROUND);
		oapiRegisterPanelArea (AID_CMRCS_HE_DUMP_SWITCH,				_R( 666, 785,  734,  815), PANEL_REDRAW_ALWAYS, PANEL_MOUSE_DOWN,PANEL_MAP_BACKGROUND);
		oapiRegisterPanelArea (AID_BUS_LIGHT,							_R(2445, 595, 2461,  611), PANEL_REDRAW_ALWAYS, PANEL_MOUSE_IGNORE,PANEL_MAP_BACKGROUND);
		oapiRegisterPanelArea (AID_CABIN_LIGHT,							_R(1781, 555, 1797,  571), PANEL_REDRAW_ALWAYS, PANEL_MOUSE_DOWN,PANEL_MAP_BACKGROUND);
		oapiRegisterPanelArea (AID_CABIN_GAUGES,						_R(1693, 443, 1857,  531), PANEL_REDRAW_ALWAYS, PANEL_MOUSE_DOWN,PANEL_MAP_BACKGROUND);
		oapiRegisterPanelArea (AID_EMS_KNOB,							_R( 442, 208,  510,  276), PANEL_REDRAW_ALWAYS, PANEL_MOUSE_DOWN,PANEL_MAP_BACKGROUND);
