...
//
	...
	case SATPANEL_LOWER: // guidance & navigation lower equipment bay
		...
		oapiRegisterPanelArea (AID_SYSTEMTESTROTARIES,							_R(129, 213, 339, 303), PANEL_REDRAW_ALWAYS, PANEL_MOUSE_DOWN,		PANEL_MAP_BACKGROUND);
	...
	case SATPANEL_MAIN: // main instrument panel
		...
		oapiRegisterPanelArea (AID_SEPARATIONSWITCHES,		    				_R(1087,  935, 1341, 1004), PANEL_REDRAW_ALWAYS, PANEL_MOUSE_DOWN|PANEL_MOUSE_UP,	PANEL_MAP_BACKGROUND);
		...
		oapiRegisterPanelArea (AID_FUELCELLINDICATORSSWITCH,    				_R(3027,  627, 3117,  717), PANEL_REDRAW_ALWAYS, PANEL_MOUSE_DOWN,					PANEL_MAP_BACKGROUND);
		...
		oapiRegisterPanelArea (AID_SMRCS_HELIUM2_SWITCHES,						_R(1411,  564, 1748,  633), PANEL_REDRAW_ALWAYS, PANEL_MOUSE_DOWN|PANEL_MOUSE_UP,	PANEL_MAP_BACKGROUND);
		...
		oapiRegisterPanelArea (AID_RCS_INDICATORS,								_R(1785,  445, 1875,  535), PANEL_REDRAW_ALWAYS, PANEL_MOUSE_DOWN,					PANEL_MAP_BACKGROUND);
		oapiRegisterPanelArea (AID_RCS_GAUGES,									_R(1385,  385, 1548,  511), PANEL_REDRAW_ALWAYS, PANEL_MOUSE_IGNORE,				PANEL_MAP_BACKGROUND);
		oapiRegisterPanelArea (AID_LV_SWITCHES,									_R(1043, 1138, 1173, 1207), PANEL_REDRAW_ALWAYS, PANEL_MOUSE_DOWN|PANEL_MOUSE_UP,	PANEL_MAP_BACKGROUND);
		oapiRegisterPanelArea (AID_ALTIMETER,									_R( 836,   85,  973,  222), PANEL_REDRAW_ALWAYS, PANEL_MOUSE_IGNORE,				PANEL_MAP_BACKGROUND);
		oapiRegisterPanelArea (AID_ECS_INDICATOR_SWITCH,						_R(1785,  582, 1875,  672), PANEL_REDRAW_ALWAYS, PANEL_MOUSE_DOWN,					PANEL_MAP_BACKGROUND);
		...
		oapiRegisterPanelArea (AID_MAIN_RELEASE_SWITCH,							_R(1042, 1228, 1078, 1297), PANEL_REDRAW_ALWAYS, PANEL_MOUSE_DOWN|PANEL_MOUSE_UP,	PANEL_MAP_BACKGROUND);
		oapiRegisterPanelArea (AID_ABORT_ROW,									_R(1042, 1027, 1294, 1096), PANEL_REDRAW_ALWAYS, PANEL_MOUSE_DOWN|PANEL_MOUSE_UP,	PANEL_MAP_BACKGROUND);
		...
		oapiRegisterPanelArea (AID_HIGHGAINANTENNAPITCHPOSITIONSWITCH,			_R(2268, 1016, 2358, 1116), PANEL_REDRAW_ALWAYS, PANEL_MOUSE_DOWN,					PANEL_MAP_BACKGROUND);
		...
		oapiRegisterPanelArea (AID_DOCKINGPROBESWITCHES,    					_R(1388,  256, 1509,  325), PANEL_REDRAW_ALWAYS, PANEL_MOUSE_DOWN|PANEL_MOUSE_UP,	PANEL_MAP_BACKGROUND);
		...
		oapiRegisterPanelArea (AID_HIGHGAINANTENNAYAWPOSITIONSWITCH,      		_R(2398, 1016, 2488, 1116), PANEL_REDRAW_ALWAYS, PANEL_MOUSE_DOWN,					PANEL_MAP_BACKGROUND);
		oapiRegisterPanelArea (AID_VHFANTENNAROTARY,      						_R(2593,  184, 2683,  274), PANEL_REDRAW_ALWAYS, PANEL_MOUSE_DOWN,					PANEL_MAP_BACKGROUND);
		...
		oapiRegisterPanelArea (AID_DCINDICATORSROTARY,      					_R(3180,  896, 3270,  986), PANEL_REDRAW_ALWAYS, PANEL_MOUSE_DOWN,					PANEL_MAP_BACKGROUND);
		oapiRegisterPanelArea (AID_BATTERYCHARGEROTARY,      					_R(3336,  896, 3426,  986), PANEL_REDRAW_ALWAYS, PANEL_MOUSE_DOWN,					PANEL_MAP_BACKGROUND);
		...
		oapiRegisterPanelArea (AID_ACINDICATORROTARY,							_R(3386, 1205, 3476, 1295), PANEL_REDRAW_ALWAYS, PANEL_MOUSE_DOWN,					PANEL_MAP_BACKGROUND);
	...
	case SATPANEL_LEFT: // left instrument panel
		...
		oapiRegisterPanelArea (AID_POSTLANDINGDYEMARKERSWITCH,		    		_R(1428,   71, 1474,  146), PANEL_REDRAW_ALWAYS, PANEL_MOUSE_DOWN|PANEL_MOUSE_UP,	PANEL_MAP_BACKGROUND);
		...
		oapiRegisterPanelArea (AID_FLOATBAGSWITCHES,							_R( 957, 1123, 1111, 1175), PANEL_REDRAW_ALWAYS, PANEL_MOUSE_DOWN,					PANEL_MAP_BACKGROUND);
		oapiRegisterPanelArea (AID_SEQEVENTSCONTSYSTEM,							_R(1120, 1123, 1291, 1175), PANEL_REDRAW_ALWAYS, PANEL_MOUSE_DOWN,					PANEL_MAP_BACKGROUND);
		...
		oapiRegisterPanelArea (AID_FDAIPOWERROTARY,								_R( 786, 1401,  876, 1491), PANEL_REDRAW_ALWAYS, PANEL_MOUSE_DOWN,					PANEL_MAP_BACKGROUND);
		oapiRegisterPanelArea (AID_SCSELECTRONICSPOWERROTARY,					_R( 659, 1408,  749, 1498), PANEL_REDRAW_ALWAYS, PANEL_MOUSE_DOWN,					PANEL_MAP_BACKGROUND);
		oapiRegisterPanelArea (AID_BMAGPOWERROTARY1,							_R( 520, 1419,  610, 1509), PANEL_REDRAW_ALWAYS, PANEL_MOUSE_DOWN,					PANEL_MAP_BACKGROUND);
		oapiRegisterPanelArea (AID_BMAGPOWERROTARY2,							_R( 586, 1511,  676, 1601), PANEL_REDRAW_ALWAYS, PANEL_MOUSE_DOWN,					PANEL_MAP_BACKGROUND);
...
void Saturn::SetSwitches(int panel) {
	...
	dVThrust1Switch.Init(1, 23, 34, 29, srf[SRF_SWITCHUP], srf[SRF_BORDER_34x29], dvThrustRow);
	dVThrust1Switch.InitGuard(0, 0, 36, 69, srf[SRF_SWITCHGUARDS], srf[SRF_BORDER_34x61]);
	dVThrust2Switch.Init(95, 23, 34, 29, srf[SRF_SWITCHUP], srf[SRF_BORDER_34x29], dvThrustRow);
